...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private DatabaseHelper(Context context, String DB_NAME, int version) {
        ...
        //System.out.println("DatabaseHelper.DatabaseHelper "+ApplicationController.getInstance().getFilesDir().getParentFile().getPath());
        this.mContext = context;
        try {
            //System.out.println("DatabaseHelper.DatabaseHelper== Initializing database..."+DB_NAME);
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS fav_product( _id INTEGER PRIMARY KEY AUTOINCREMENT, category_id INTEGER, product_id INTEGER, TOTAL_PRICE INTEGER)");
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        //System.out.println("DatabaseHelper.onUpgrade === "+"Upgrading started...older version = " + oldVersion + " and new version = " + newVersion);
    }
}
