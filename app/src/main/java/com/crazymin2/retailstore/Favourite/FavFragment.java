 ...
 */
public class FavFragment extends Fragment /*implements LoaderManager.LoaderCallbacks<List<Product>>*/ {

    private static final String TAG = LogUtils.makeLogTag(FavFragment.class);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mAdapter = new FavListAdapter(getActivity(), mEmptyView, new FavListAdapter.FavClickedInterface() {
            @Override
            public void onTouchArea(int position) {
                ...
                startActivityForResult(intent, AddCartDialogActivity.REQUEST_TO_ADD_IN_FAV);
            }

            @Override
            public void onDeletePressed(int position) {
                Product product = mAdapter.getItem(position);
                ((BaseActivity) getActivity()).favPresenter.removeItem(product);
...
//    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == AddCartDialogActivity.REQUEST_TO_ADD_IN_FAV) {
            refreshAdapter();
        }
    }
...
//    }
    ...
    public void removeData(Object data) {
        Toast.makeText(getActivity(), "Item removed from favourites", Toast.LENGTH_SHORT).show();
        mAdapter.remove((Product) data);
        refreshAdapter();
    }


    public static class FavListAdapter extends ArrayAdapter<Product> {
        private final LayoutInflater mInflater;
        private FavClickedInterface favClickedInterface = null;
        private Context mContext;
        private View mEmptyView;

        public interface FavClickedInterface {
        ...
        public FavListAdapter(Context context, View emptyView, FavClickedInterface listener) {
            super(context, R.layout.cart_row);
            mContext = context;
            mEmptyView = emptyView;
            mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            favClickedInterface = listener;
        }
        ...
        public View getView(final int position, View view, ViewGroup parent) {
            ...
            holder.deleteCart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (favClickedInterface != null)
                        favClickedInterface.onDeletePressed(position);
                }
            });
            holder.touchArea.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (favClickedInterface != null)
                        favClickedInterface.onTouchArea(position);
                }
            });
